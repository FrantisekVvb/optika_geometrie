  ...
  return (
    <>
      ...
      <BrowserRouter basename={routerBase}>
        <Routes>
          <Route path="/" element={<Landing mode="rysovani-app" />} />
          <Route path="/menu-rysovani" element={<Landing mode="rysovani-app" />} />
          <Route path="/menu-telesa" element={<Navigate to="/menu-rysovani" replace />} />
          <Route path="/rysovani-app" element={<Navigate to="/menu-rysovani" replace />} />
          <Route path="/telesa-app" element={<Navigate to="/menu-rysovani" replace />} />
          ...
          />
          <Route path="/cviceni" element={<Navigate to="/menu-rysovani" replace />} />
